define(function(require, exports, module) {
	...
	var MultiSelect=require('./select/multiSelect.js');
    /**
     * 选择项子类
     * @class SelectItem
        ...
        render:function(){
            ...
            return (
                <div onClick={this.toggleOpen} className={className} style={{width:this.props.width+'px'}}>
                    ...
                    {this.props.multi?<MultiSelect displayText={displayText} close={this.closeClick}/>:<OneSelect displayText={displayText} iconClass={iconClass} value={this.state.value}/>}
                    <div className="chosen-drop">
                    	{this.props.search&&!this.props.multi?<Search name={this.props.name} changeHandle={this.textChange} onClick={this.textClick}/>:""}
