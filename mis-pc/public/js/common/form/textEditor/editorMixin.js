define(function (require, exports, module) {
    ...
    module.exports = {
        ...
        __matchesSelectorForIE:function(selector) {
            var elem = this;
            var $elems = $(selector);
            var result = false;
        ...
        getSelfOrParentByName:function (elem, selector, check) {
            ...
            if (!matchesSelector) {
                ...
                matchesSelector = this.__matchesSelectorForIE;
            }

            var txt = this.textEditor.get(0);
