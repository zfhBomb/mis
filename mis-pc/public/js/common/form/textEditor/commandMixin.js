define(function (require, exports, module) {
    ...
    module.exports={
        ...
        // 针对一个elem对象执行基础命令
        commandForElem:function (elemOpt, e, commandName, commandValue, callback) {
            // 取得查询elem的查询条件和验证函数
            var selector;
            var check;
        ...
        // 自定义命令
        customCommand:function (e, commandFn, callback) {
            var editor = this;
        ...
        queryCommandSupported:function (commandName) {
            var result = false;
            try {
